...
params = dict(dorsal = >=((n-1)/n), k_Bmp = 0.1, k_Admp = 0.1, λ_Chd = 0.1, λ_ChdBmp = 0.1, λ_ChdAdmp = 0.1, η_Chd = 10^1.5, Xlr = 0.01, D_Chd = 1.0, D_Lig = 1.0, D_Comp = 1.0, T_Admp = 1e-4, L=1000.0)
...
optimise(model, cost, vars, params; sample=sample, dt=0.001, tspan=1000.0, num_verts=n)
